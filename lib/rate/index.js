...
var _index3 = require("antd/lib/icon/index");
...
var JwRate = function (_Component) {
  ...
  _createClass(JwRate, [{
    ...
    value: function addClassName() {
      ...
      var count = jw_rate_count;
      var countClass = 'jw-rate-count-' + count;
      return countClass;
    }
  }, {
    key: "render",
    value: function render() {
      ...
      props.character = this.props.character == "number" ? this.props.character : _react2.default.createElement(_index4.default, { type: this.props.character });
